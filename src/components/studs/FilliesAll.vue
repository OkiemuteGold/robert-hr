...
export default {
    ...
    computed: {
        ...mapState(["allFilliesHorses"]),
    },

    methods: {
        ...mapActions(["setAllFilliesHorses"]),
    },

    mounted() {
        this.setAllFilliesHorses();

        if (this.allFilliesHorses) {
            this.filliesHorses = this.allFilliesHorses;
        }
    },
};
</script>
...
.all-horses-wrapper .image img {
    height: 180px;
    -o-object-fit: cover;
    object-fit: cover;
}

.all-horses-wrapper h3 {
    font-size: 20px;
}

.all-horses-wrapper h3 a {
    color: var(--black1);
}

.all-horses-wrapper h3 a:hover {
    color: var(--yellowDark);
    text-decoration: none;
}

.all-horses-wrapper p {
    font-size: 15px;
}
